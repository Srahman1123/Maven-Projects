...
public class Google_test_with_loop {
    public static void main(String[] args) throws InterruptedException {
        ...
        //create a dynamic array for city loop through certain values from the array
        ...
        for (int i = 0; i < city.length; i++) {
            ...
            //locate the search field by inspecting it first and then enter a keyword let say city
